...
class Akun extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/menu_master/v_akun', $data);
    ...
    public function tambah_data_aksi()
    {
        ...
        // Validasi apakah username sudah digunakan sebelumnya
        $username_exists = $this->M_akun->validasi($username);
        if ($username_exists > 0) {
            $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-dismissible fade show" role="alert">
			<strong>Username sudah digunakan. Silakan gunakan username lain !</strong>
			<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			  <span aria-hidden="true">&times;</span>
			</button>
		  </div>');
    ...
    public function update_data($id)
    {
        ...
        $this->load->view('admin/template/header');
        $this->load->view('admin/template/sidebar');
        $this->load->view('admin/menu_master/v_akun_edit', $data);
        $this->load->view('admin/template/footer');
    }
