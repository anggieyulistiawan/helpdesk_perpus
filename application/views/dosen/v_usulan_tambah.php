<div class="container-fluid">
    ...
    <form method="POST" action="<?php echo base_url('dosen/usulan/tambah_data_aksi/') ?>" enctype="multipart/form-data">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-3">
                    ...
                    <div class="col-4">
                        <label>NIP/NIK</label>
                        <input type="number" name="idp" value="<?= $this->session->userdata('idp'); ?>" class="form-control" readonly>
                    </div>
