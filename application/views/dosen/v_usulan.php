                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col-6">
                                    <a class="btn btn-sm btn-success m-0" href="<?php echo base_url('dosen/usulan/tambah_data') ?>">
                                ...
                                <div class="modal-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>Actions</th>
                                            <td>
                                                <a class="btn btn-sm btn-primary" href="<?php echo base_url('dosen/usulan/update_data/' . $u->id_usulan) ?>"><i class="fas fa-edit"></i> Edit</a>
                                                <a onclick="return confirm ('Yakin Hapus')" class="btn btn-sm btn-danger" href="<?php echo base_url('dosen/usulan/delete_data/' . $u->id_usulan) ?>"><i class="fas fa-trash"></i> Delete</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
