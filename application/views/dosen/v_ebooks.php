                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <!-- <div class="card-header py-3">
                            <div class="row">
                                <div class="col-6">
                                    <a class="btn btn-sm btn-success m-0" href="<?php echo base_url('dosen/ebooks/tambah_data') ?>">
                                        ...
                                        <div class="col-md-8">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($e->buku == null) { ?>
                                                            <a class="btn btn-sm btn-secondary disabled" title="Views"><i class="fas fa-eye"></i> Baca Buku</a>
                                                        <?php } else { ?>
                                                            <a class="btn btn-sm btn-secondary" title="Views" href="<?php echo base_url('dosen/ebooks/detail_views/' . $e->id_ebooks) ?>" target="_blank"><i class="fas fa-eye"></i> Baca Buku</a> <?php } ?>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
