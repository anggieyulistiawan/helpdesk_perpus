                                    ...
                                    <tbody>
                                        ...
                                        foreach ($akun as $a) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img class="rounded-circle" src="<?php echo base_url() . 'assets/foto/' . $a->foto ?>" width="40px">
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else if ($a->nama_level == 'MAHASISWA') { ?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-4">
                                            <tr>
                                                <img class=" mt-lg-5" src="<?php echo base_url() . 'assets/foto/' . $a->foto ?>" width="200px">
                                            </tr>
                                        </div>
                                        <div class="col-md-8">
                                            <table class="table">
