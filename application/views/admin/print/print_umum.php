...
<div class="container-fluid">
    ...
    <center>
        <table class="kop mb-5">
            <td style="font-size: 30px; font-weight: bold;">Laporan Arsip Surat Umum</td>
        </table>
    </center>
    ...
    <div>
        <table class="isi" style="width:100%;">
            ...
            <tbody style="line-height: 30px;">
                <?php $no = 1;
                foreach ($print_umum as $d) : ?>
                    <tr>
                        <td><?php echo $no++ ?></td>
                        <td><?php echo format_indo(date($d->tanggal_surat)); ?></td>
                        <td>Nomor: <?php echo $d->nomor_surat ?>/PL40.14/TU/<?php echo date("Y", strtotime($d->tanggal_surat)); ?></td>
