<div class="container-fluid">
    <!-- Page Heading -->
    <h4 class="mb-5 text-gray-800">Rekap Laporan / <strong>Pengajuan Surat Bebas Perpustakaan (Lulus Kuliah)</strong></h4>
    ...
    <div class="card mx-auto" style="width: 55%">
        ...
        <form method="POST" action="<?= base_url('admin/print_lulus_kuliah/cetaklaporanlulus') ?>" target="_blank">
            <div class="card-body">
