                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <!-- <div class="card-header py-3">
                            <div class="row">
                                <div class="col-6">
                                    <a class="btn btn-sm btn-success m-0" href="<?php echo base_url('user/ebooks/tambah_data') ?>">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php } else { ?>
                                                            <a class="btn btn-sm btn-secondary" title="Views" href="<?php echo base_url('user/ebooks/detail_views/' . $e->id_ebooks) ?>" target="_blank"><i class="fas fa-eye"></i> Baca Buku</a> <?php } ?>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
