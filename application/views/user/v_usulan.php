                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row">
                                <div class="col-6">
                                    <a class="btn btn-sm btn-success m-0" href="<?php echo base_url('user/usulan/tambah_data') ?>">
                                ...
                                <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th> </th>
                                            <th>Tanggal</th>
                                            <th>Judul buku yang diusulkan</th>
                                            <th>Alasan</th>
                                            <th>Status</th>
                                        </tr>
                                    </thead>
                                ...
                                <div class=" modal-body">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>Actions</th>
                                            <td>
                                                <a class="btn btn-sm btn-primary" title="Edit" href="<?php echo base_url('user/usulan/update_data/' . $u->id_usulan) ?>"><i class="fas fa-edit"></i> Edit</a>
                                                <a onclick="return confirm ('Yakin Hapus')" class="btn btn-sm btn-danger" title="Delete" href="<?php echo base_url('user/usulan/delete_data/' . $u->id_usulan) ?>"><i class="fas fa-trash"></i> Delete</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
