<div class="container-fluid">
    ...
    <form method="POST" action="<?php echo base_url('user/profile/update_data_aksi/') ?>" enctype="multipart/form-data">
        <div class="row">
            <div class="col-4">
                <div class="card">
                    ...
                    <div class="card-body" style="background-color: whitesmoke;">
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-5">
                                ...
                                <label class="small mb-1">Nomor Induk Mahasiswa</label>
                                <input class="form-control" name="idp" type="number" placeholder="Enter your NIM " value="<?php echo $akun->idp ?>">
