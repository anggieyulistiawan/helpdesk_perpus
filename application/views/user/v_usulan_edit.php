<div class="container-fluid">
    ...
    <?php foreach ($usulan as $u) : ?>
        <form method="POST" action="<?php echo base_url('user/usulan/update_data_aksi/') ?>" enctype="multipart/form-data">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-2">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="id_akun" value="<?= $this->session->userdata('idp'); ?> - <?php echo $this->session->userdata('nama_akun') ?>" class="form-control" readonly>
                        </div>

                        <div class="col-4">
                            <label>Program Studi</label>
                            <input type="text" name="id_prodi" value="<?= $this->session->userdata('diploma'); ?> - <?php echo $this->session->userdata('nama_prodi') ?>" class="form-control" readonly>
                        </div>
                    </div>
                </div>
